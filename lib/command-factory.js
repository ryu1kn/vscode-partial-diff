...
const NormalisationRulePicker = require('./normalisation-rule-picker')
const NormalisationRuleStore = require('./normalisation-rule-store')
const SelectionInfoBuilder = require('./selection-info-builder')
const ToggleNormalisationRulesCommand = require('./commands/toggle-normalisation-rules')
...
class CommandFactory {
  ...
  createToggleNormalisationRulesCommand () {
    return new ToggleNormalisationRulesCommand({
      ...
      normalisationRuleStore: new NormalisationRuleStore({
