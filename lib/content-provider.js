...
class ContentProvider {
    ...
    constructor(params) {
        ...
        this._textProcessRuleApplier = new TextProcessRuleApplier({configStore: params.configStore});
    }

    provideTextDocumentContent(uri) {
        const textKey = this._textResourceUtil.getTextKey(uri);
        const registeredText = (this._selectionInfoRegistry.get(textKey) || {text: ''}).text;
